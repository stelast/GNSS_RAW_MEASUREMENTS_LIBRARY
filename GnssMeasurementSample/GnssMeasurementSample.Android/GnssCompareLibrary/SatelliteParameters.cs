...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary
{
    public class SatelliteParameters
    {
         ...
         */
        protected Coordinates<Matrix> coordinates;
         ...
         */
        private GnssConstellationType constellationType;
         ...
         */
        protected void setCoordinates(Coordinates<Matrix> newPose)
        {
            coordinates = newPose;
        }
         ...
         */
        private TopocentricCoordinates<Matrix> rxTopo;

        /**
         * @return asimuth and elevation of the satellite with respect to the user
         */
        public TopocentricCoordinates<Matrix> getRxTopo()
        {
            return rxTopo;
        }
         ...
         */
        public void setRxTopo(TopocentricCoordinates<Matrix> rxTopo)
        { //todo rename to better indicate function
            this.rxTopo = rxTopo;
         ...
         */
        public void setConstellationType(GnssConstellationType constellationType)
        {
