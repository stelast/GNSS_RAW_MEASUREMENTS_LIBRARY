...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary.Corrections
{
    public class IonoGps : Streamable
    {
		...
		public IonoGps(DataInputStream dai, bool oldVersion) /*throws IOException*/
		{
			read(dai, oldVersion);
		}
		...
		public int write(DataOutputStream dos) /*throws IOException*/
		{
			...
			//}
			//dos.writebool(validHealth); size +=1;
			//dos.writebool(validUTC); size +=1;
			//dos.writebool(validKlobuchar); size +=1;
		...
		public void read(DataInputStream dai, bool oldVersion) /*throws IOException*/
		{
			...
			//	}
			//	validHealth = dai.readbool();
			//	validUTC = dai.readbool();
			//	validKlobuchar = dai.readbool();
			//	long l = dai.readLong();
