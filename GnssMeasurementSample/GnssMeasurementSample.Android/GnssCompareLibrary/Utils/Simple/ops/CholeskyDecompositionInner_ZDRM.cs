...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary.Utils.Simple.ops
{
    public class CholeskyDecompositionInner_ZDRM: CholeskyDecompositionCommon_ZDRM
    {
        ...
        public CholeskyDecompositionInner_ZDRM() : base(true)
        {
        }

        public CholeskyDecompositionInner_ZDRM(bool lower) : base(lower)
        {
        }
        ...
        public virtual bool decompose(ZMatrixRMaj mat)
        {
