    ...
    public class SpecializedOps_DDRM
    {
        ...
        public static DMatrixRMaj copyChangeRow(int[] order, DMatrixRMaj src,  DMatrixRMaj dst )
        {
            ...
            for (int i = 0; i < src.numRows; i++)
            {
                ...
                System.Array.Copy(src.data, indexSrc, dst.data, indexDst, src.numCols);
            }
        ...
        public static DMatrixRMaj copyTriangle(DMatrixRMaj src,  DMatrixRMaj dst, bool upper)
        {
            ...
            if (upper)
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    ...
                    System.Array.Copy(src.data, index, dst.data, index, src.numCols - i);
                }
            }
            else
            {
                for (int i = 0; i < src.numRows; i++)
                {
                    ...
                    System.Array.Copy(src.data, index, dst.data, index, length);
                }
            }
