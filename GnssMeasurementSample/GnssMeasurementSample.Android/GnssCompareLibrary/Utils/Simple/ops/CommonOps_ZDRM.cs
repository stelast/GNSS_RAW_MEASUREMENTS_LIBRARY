...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary.Utils.Simple.ops
{
    public class CommonOps_ZDRM
    {
        ...
        public static ZMatrixRMaj diag(double[] data )
        {
            ...
            return diag(new ZMatrixRMaj(1, 1), data.Count() / 2, data);
        }
        ...
        public static void convert(DMatrixD1 input, ZMatrixD1 output)
        {
            ...
            Array.Fill(output.data, 0, output.DataLength, 0);

             int length = output.DataLength;
         ...
         */
        public static ZMatrixRMaj elementMultiply(ZMatrixD1 input, double real, double imaginary,  ZMatrixRMaj output )
        {
            output = UtilEjml.reshapeOrDeclare(output, input.numRows, input.numCols);
         ...
         * @param output Where the results of the operation are stored. Modified.
         */
        public static ZMatrixRMaj elementDivide(ZMatrixD1 input, double real, double imaginary,  ZMatrixRMaj output )
        {
            output = UtilEjml.reshapeOrDeclare(output, input.numRows, input.numCols);
        ...
        public static void setIdentity(ZMatrixRMaj mat)
        {
            ...
            Array.Fill(mat.data, 0, mat.DataLength, 0);
