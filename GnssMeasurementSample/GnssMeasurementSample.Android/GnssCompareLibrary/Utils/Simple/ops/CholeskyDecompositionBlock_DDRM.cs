...
{
    public class CholeskyDecompositionBlock_DDRM : CholeskyDecompositionCommon_DDRM
    {
         ...
         */
        public CholeskyDecompositionBlock_DDRM(int blockWidth) : base(true)
        {
        ...
        {
            throw new SystemException("Not implemented. Do a lower decomposition and transpose it...");
        }
         ...
         */
        public void solveL_special( double[] L,
                                     DMatrixRMaj b_src,
