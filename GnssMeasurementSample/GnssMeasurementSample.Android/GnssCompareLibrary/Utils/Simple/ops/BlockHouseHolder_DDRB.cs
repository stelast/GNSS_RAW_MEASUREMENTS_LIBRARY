...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary.Utils.Simple.ops
{
    public class BlockHouseHolder_DDRB
    {
         ...
         */
        public static bool decomposeQR_block_col(int blockLength,
                                                     DSubmatrixD1 Y,
                                                     double[] gamma)
        {
        ...
        public static void rank1UpdateMultL_Row(int blockLength,
                                                 DSubmatrixD1 A,
                                                 int row, int colStart, double gamma)
        {
        ...
        public static void rank1UpdateMultL_LeftCol(int blockLength,
                                                     DSubmatrixD1 A,
                                                     int row, double gamma, int zeroOffset)
        {
         ...
         * from zero is automatically taken in account based on the column.
         */
        public static double findMaxRow(int blockLength,
                                         DSubmatrixD1 Y,
                                         int row, int colStart)
        {
            int height = Math.Min(blockLength, Y.row1 - Y.row0);
        ...
        public static void computeW_Column(int blockLength,
                                            DSubmatrixD1 Y, DSubmatrixD1 W,
                                             GrowArray<DGrowArray> workspace, double[] beta, int betaIndex)
        {
            ...
            double[] temp = workspace.grow().reshape(Y.col1 - Y.col0).data;
         ...
         * column 'col'.
         */
        public static void computeZ(int blockLength, DSubmatrixD1 Y, DSubmatrixD1 W,
