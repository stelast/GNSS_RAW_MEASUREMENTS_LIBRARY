...
namespace GnssMeasurementSample.Droid.GnssCompareLibrary.Utils.Simple.ops
{
    public class UnrolledCholesky_DDRM
    {
        ...
        public static bool lower(DMatrix1Row A, DMatrix1Row L)
        {
            switch (A.numRows)
            {
        ...
        public static bool upper(DMatrix1Row A, DMatrix1Row L)
        {
            switch (A.numRows)
            {
        ...
        public static bool lower3(DMatrix1Row A, DMatrix1Row L)
        {
            double[] data = A.data;
        ...
        public static bool lower6(DMatrix1Row A, DMatrix1Row L)
        {
            double[] data = A.data;
        ...
        public static bool lower7(DMatrix1Row A, DMatrix1Row L)
        {
            double[] data = A.data;
        ...
        public static bool upper1(DMatrix1Row A, DMatrix1Row R)
        {
            double[] data = A.data;
        ...
        public static bool upper3(DMatrix1Row A, DMatrix1Row R)
        {
            double[] data = A.data;
        ...
        public static bool upper6(DMatrix1Row A, DMatrix1Row R)
        {
            double[] data = A.data;
        ...
        public static bool upper7(DMatrix1Row A, DMatrix1Row R)
        {
            double[] data = A.data;
